...
const AGENT_TYPES = [
  ...
  },
  {
    ...
    icon:  Database,
    title: "RAG Agent",
    desc:  "Augment with a knowledge base. Retrieves relevant docs at runtime before answering. Perfect for Q&A over custom data.",
  ...
  },
  {
    ...
    desc:  "Chain agents in sequence — output of agent A flows automatically into agent B. Build complex automated workflows.",
    badge: "Advanced",
...
export default function BuilderPage() {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      {/* Left sidebar — same as dashboard for consistent navigation */}
      <DashboardSidebar />
        ...
        <div className="max-w-2xl mx-auto px-6 py-8">
          ...
          {step === 0 && (
            <div className="space-y-6">
              ...
              {/* Pipeline type → redirect to Pipeline Studio */}
              {agentType === "pipeline" ? (
                <div className="space-y-3">
                  <div className="bg-amber-50 border border-amber-100 rounded-2xl px-5 py-4">
                    ...
                    <p className="text-xs text-amber-700 leading-relaxed">
                      Create individual agents first, then chain them together using the
                      Pipeline Studio. Each node in a pipeline is an independent agent
                      — the output of one flows into the next automatically.
                    </p>
                  </div>
                      ...
                      {agentType === "rag" && (
                        <div className="flex items-start gap-2 bg-green-50 border border-green-100 rounded-xl px-4 py-3">
                          ...
                          <p className="text-xs text-green-700 leading-relaxed">
                            <strong>RAG Agent:</strong> You&apos;ll attach a knowledge base after creation
                            in the editor&apos;s Knowledge Base tab.
                          </p>
                        </div>
                      )}
                  ...
                  <div className="space-y-4">
                    <div className="bg-white border border-zinc-100 rounded-2xl p-6 space-y-5"
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Textarea rows={9}
                          placeholder={`You are an expert ${agentType === "rag" ? "document assistant. Use the provided context to answer questions accurately and cite sources.\n\nContext will be injected automatically before the user question." : "task specialist.\n\n1. Analyse the user input carefully\n2. Produce a structured, accurate response\n\nAlways respond in valid JSON."}`}
                          className={cn(
                            "rounded-xl font-mono text-xs resize-none leading-relaxed bg-white",
                        ...
                        {errors.system_prompt
                          ...
                          : <p className="text-xs text-zinc-400">Define persona, instructions, and output format.</p>
                        }
                      </div>
                    ...
                    <div className="flex gap-3">
                      <Button type="button" variant="outline" onClick={() => setStep(1)}
                        className="flex-1 rounded-xl h-11 font-semibold border-zinc-200">Back</Button>
                    ...
                    <div className="bg-white border border-zinc-100 rounded-2xl p-6 space-y-5"
                        ...
                        {([
                          ...
                          <button key={p.key} type="button"
                            ...
                            <div className={cn("font-bold text-sm mb-0.5",
                              pricingModel === p.key ? "text-white" : "text-zinc-900")}>{p.label}</div>
                            <div className={cn("text-xs",
                              pricingModel === p.key ? "text-zinc-400" : "text-zinc-500")}>{p.sub}</div>
                          </button>
                        ))}
                      </div>
                      ...
                      {pricingModel === "free" && (
                        <p className="text-xs text-zinc-400 leading-relaxed">
                          Free agents are publicly accessible at no cost. AgentDyne covers inference within platform quota.
                          Starts as a <strong className="text-zinc-600">draft</strong> — submit for review when ready.
                        </p>
                      )}
                      ...
                      {/* Post-creation capabilities hint */}
                      <div className="pt-3 border-t border-zinc-50 space-y-2">
                        ...
                        <div className="grid grid-cols-1 gap-1.5">
                          {[
                            ...
                            { icon: Layers,   color: "text-violet-500", text: "Add MCP tools (Slack, GitHub, Supabase…) in the MCP tab" },
