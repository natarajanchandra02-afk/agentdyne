...
export default async function AdminPage() {
  ...
  return <AdminClient stats={{ totalUsers: totalUsers || 0, totalAgents: totalAgents || 0, pendingAgents: pendingAgents || 0, totalRevenue }} recentAgents={recentAgents || []} recentUsers={recentUsers || []} />
}
