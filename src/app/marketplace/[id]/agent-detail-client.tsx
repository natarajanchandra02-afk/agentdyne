...
export function AgentDetailClient({ agent, reviews, user, userSubscription }: Props) {
  ...
  // Bug fixes:
  // 1. Correct endpoint: /api/agents/[id]/execute (was /api/execute — old deleted route)
  // 2. Safe JSON.parse — fall back to raw string instead of crashing
                ...
                <TabsContent value="playground" className="mt-4 space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className={`h-48 rounded-xl border border-zinc-100 bg-zinc-50 p-3 font-mono text-xs overflow-auto whitespace-pre-wrap text-zinc-500 ${testing ? "animate-pulse" : ""}`}>
