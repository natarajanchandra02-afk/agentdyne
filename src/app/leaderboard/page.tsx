...
import {
  Trophy, Zap, DollarSign, Shield, TrendingUp,
        ...
        <div className="bg-zinc-50 border-b border-zinc-100">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
            ...
            <p className="text-zinc-500 max-w-xl">
              Objective quality rankings based on accuracy, reliability, speed,
              cost efficiency, and adoption — not just stars.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-20 text-zinc-400">
              ...
              <p className="font-semibold">No ranked agents yet in this filter.</p>
              ...
              {agents.map((agent, i) => {
                ...
                return (
                  <div key={agent.id}
                    ...
                    <div className="flex items-center gap-4 px-5 py-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {agent.is_top_rated    && <span className="text-[10px] font-bold bg-violet-50 text-violet-700 px-1.5 py-0.5 rounded-full">Top Rated</span>}
                          {agent.is_fastest      && <span className="text-[10px] font-bold bg-blue-50   text-blue-700   px-1.5 py-0.5 rounded-full">Fastest</span>}
                          {agent.is_cheapest     && <span className="text-[10px] font-bold bg-green-50  text-green-700  px-1.5 py-0.5 rounded-full">Cheapest</span>}
                          {agent.is_most_reliable && <span className="text-[10px] font-bold bg-amber-50  text-amber-700  px-1.5 py-0.5 rounded-full">Reliable</span>}
                        </div>
                    ...
                    {isOpen && (
                      <div className="px-5 pb-5 border-t border-zinc-50 pt-4 grid grid-cols-1 sm:grid-cols-5 gap-4">
                        {[
          ...
          <p className="text-center text-xs text-zinc-400 mt-8">
            Scores are computed automatically every 24h from live execution data.
            Agents need at least 10 successful executions to qualify.
          </p>
        </div>
      </div>
      <Footer />
