...
export class ExecutionsResource {
    ...
    async get(executionId) {
        return this.http.get(`/v1/executions/${executionId}`);
    }
    /**
     ...
     */
    async list(params) {
        return this.http.get("/v1/executions", params);
    }
    /**
     ...
     */
    async poll(executionId, options = {}) {
...
export class UserResource {
    ...
    async update(updates) {
        return this.http.patch("/v1/user/me", updates);
    }
    /**
     ...
     */
    async quota() {
        return this.http.get("/v1/user/quota");
    }
}
// ---------------------------------------------------------------------------
...
export class NotificationsResource {
     ...
     */
    async list(params) {
        return this.http.get("/v1/notifications", params);
    }
    /**
     ...
     */
    async markAllRead() {
        return this.http.patch("/v1/notifications");
    }
}
// ---------------------------------------------------------------------------
// WebhooksResource
